...
import $cssFromFile_3 from 'Frontend/styles/views/editprofileview/edit-profile-view.css?inline';

injectGlobalCss($cssFromFile_3.toString(), 'CSSImport end', document);
import $cssFromFile_4 from 'Frontend/styles/views/enterjobposting/enter-job-posting-view.css?inline';

injectGlobalCss($cssFromFile_4.toString(), 'CSSImport end', document);
import $cssFromFile_5 from 'Frontend/styles/views/jobdetail/show-job-detail-view.css?inline';

injectGlobalCss($cssFromFile_5.toString(), 'CSSImport end', document);
import $cssFromFile_6 from 'Frontend/styles/views/entercar/enter-car-view.css?inline';

injectGlobalCss($cssFromFile_6.toString(), 'CSSImport end', document);
import $cssFromFile_7 from 'Frontend/styles/views/showcars/show-cars-view.css?inline';
